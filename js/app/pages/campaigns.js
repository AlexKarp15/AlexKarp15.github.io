export const campaigns = {
    ...
    methods:{
        ...
        get: function () {
            ...
            axios
              .post(this.parent.url + "/site/getCampaigns?auth=" + this.parent.user.auth, data)
        ...
        async del() {
            if (await this.$refs.header.$refs.msg.confirmFun("Please confirm next action", "Do you want to delete this campaign?")) {
                ...
                axios.post(this.parent.url + "/site/deleteCampaign?auth=" + this.parent.auth, data).then(function (response) {
